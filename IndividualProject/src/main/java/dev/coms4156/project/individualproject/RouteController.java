...
public class RouteController {
  ...
  /**
   * Attempts to set the enrollment count of a course within a certain department.
   *
   * @param deptCode A {@code String} representing the department.
   * @param courseCode A {@code int} representing the course within the department.
   * @param count A {@code int} representing the new enrollment count of the course within the
   *     department.
   * @return A {@code ResponseEntity} a ResponseEntity with a success message if the operation is
   *     successful, or an error message if the course is not found. Also handles any exception
   ...
   *
   * @param deptCode A {@code String} representing the code of the department containing the course
   * @param courseCode A {@code int} representing the code of the course to change the instructor
   *     for
   * @param teacher A {@code String} representing the new instructor for the course
   * @return A {@code ResponseEntity} with a success message if the operation is successful, or an
   ...
   * its location is updated accordingly to the value of new location provided in the request
   * params.
   *
   * @param deptCode A {@code String} representing the code of the department containing the course
   * @param courseCode A {@code int} representing the code of the course to change the instructor
   ...
   * @return A {@code ResponseEntity} with a success message if the operation is successful, or an
   *     error message if the course is not found, also handles any exceptions accordingly
   */
